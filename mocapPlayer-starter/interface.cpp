...
Fl_Button* changeColor_button = (Fl_Button*)0;
Fl_Button * aboutPlayer_button = (Fl_Button *)0;
Fl_Button* groundTex_button = (Fl_Button*)0;
...
Fl_Window * make_window() 
{
  ...
  { 
    ...
    {
        Fl_Button* o = changeColor_button = new Fl_Button(650, 450, 85, 45, "Ground\n Color");
        o->callback((Fl_Callback*)changeColor_callback);
        o->align(FL_ALIGN_INSIDE);
    }

    {
        Fl_Button* o = groundTex_button = new Fl_Button(650, 500, 85, 45, "Ground\n Texture");
        o->callback((Fl_Callback*)groundTex_callback);
        o->align(FL_ALIGN_INSIDE);
    }
