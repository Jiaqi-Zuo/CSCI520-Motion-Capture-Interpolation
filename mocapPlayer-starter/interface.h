...
extern Fl_Button* changeColor_button;
extern void changeColor_callback(Fl_Button* button, void*);

extern Fl_Button* groundTex_button;
extern void groundTex_callback(Fl_Button* button, void*);
